...
import mumble.nooko3.sdk.Common.NKGenericApiResultListener;
...
public class NAMActivityUtils {
     ...
     */
    public static BroadcastReceiver initializeReceiverForApiManager(Activity activity, final NKGenericApiResultListener apiResultListener, String[] actions) {
        ...
        BroadcastReceiver bRec = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                boolean boolResult = result == NKApiManagerConfig.RESULT_OK;
                if (boolResult) {
                    if (error != null) {
                        boolResult = false;
                    }
                ...
                apiResultListener.onApiResult(new NKAPIResponse(boolResult, error, intent.getAction(), intent.getExtras()));
            }
        };
        try {
