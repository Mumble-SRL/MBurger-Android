 ...
 */
public class NKPayAsyncTask_CancelSubscription extends AsyncTask<Void, Void, Void> {
     ...
     */
    private NKPayApiCancelSubscriptionListener listener;

    private int result = NKApiManagerConfig.COMMON_INTERNAL_ERROR;
    private String error;
    private Map<String, Object> map;

    public NKPayAsyncTask_CancelSubscription(Context context, String subscription) {
        this.weakContext = new WeakReference<>(context);
        this.subscription = subscription;
    }

    public NKPayAsyncTask_CancelSubscription(Context context, String custom_action, String subscription) {
        this.weakContext = new WeakReference<>(context);
        this.action = custom_action;
        this.subscription = subscription;
    }

    public NKPayAsyncTask_CancelSubscription(Context context, NKPayApiCancelSubscriptionListener listener, String subscription) {
        this.weakContext = new WeakReference<>(context);
