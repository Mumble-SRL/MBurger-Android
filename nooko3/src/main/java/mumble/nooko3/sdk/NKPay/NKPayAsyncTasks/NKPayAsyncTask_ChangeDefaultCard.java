 ...
 */
public class NKPayAsyncTask_ChangeDefaultCard extends AsyncTask<Void, Void, Void> {
     ...
     */
    private String action = NKAPIConstants.ACTION_CHANGE_DEFAULT_CARD;

    /**
     * If you wish to use a listener to retrieve the data instead of the ApiListener
     */
    private NKPayApiChangeDefaultCardListener listener;

    private int result = NKApiManagerConfig.COMMON_INTERNAL_ERROR;
    private String error;
    private Map<String, Object> map;

    public NKPayAsyncTask_ChangeDefaultCard(Context context, String card_id) {
        this.weakContext = new WeakReference<>(context);
        this.card_id = card_id;
    }

    public NKPayAsyncTask_ChangeDefaultCard(Context context, String custom_action, String card_id) {
        this.weakContext = new WeakReference<>(context);
        this.action = custom_action;
        this.card_id = card_id;
    }

    public NKPayAsyncTask_ChangeDefaultCard(Context context, NKPayApiChangeDefaultCardListener listener, String card_id) {
        this.weakContext = new WeakReference<>(context);
