package mumble.nooko3.sdk.NKData.NKProjects;
 ...
 */
public class NKProject implements Serializable {
    ...
    public NKProject(long id, String name, boolean hasBeacons, boolean hasUsers, boolean hasMultilanguage,
