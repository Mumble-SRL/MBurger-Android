 ...
 */
public class NATask_getElements extends AsyncTask<Void, Void, Void> {
    ...
    public NATask_getElements(Context context, long section_id) {
        this.weakContext = new WeakReference<>(context);
        this.section_id = section_id;
    }

    public NATask_getElements(Context context, long section_id, String custom_action) {
        this.weakContext = new WeakReference<>(context);
        this.action = custom_action;
        this.section_id = section_id;
    }

    public NATask_getElements(Context context, long section_id, NApiElementsResultListener listener) {
        this.weakContext = new WeakReference<>(context);
        this.section_id = section_id;
