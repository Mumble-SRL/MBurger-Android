...
public class ATask_getSection extends AsyncTask<Void, Void, Void> {
    ...
    public ATask_getSection(Context context, long section_id, boolean getElements) {
        this.weakContext = new WeakReference<>(context);
        this.getElements = getElements;
        this.section_id = section_id;
    }

    public ATask_getSection(Context context, long section_id, String custom_action, boolean getElements) {
        this.weakContext = new WeakReference<>(context);
    ...
    public ATask_getSection(Context context, long section_id, NApiSectionResultListener listener, boolean getElements) {
        this.weakContext = new WeakReference<>(context);
