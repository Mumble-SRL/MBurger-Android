...
public class MBStripeSubscription implements Serializable{
    ...
    public MBStripeSubscription(long id, String name, String stripe_id, String stripe_plan, int quantity, long ends_at,
