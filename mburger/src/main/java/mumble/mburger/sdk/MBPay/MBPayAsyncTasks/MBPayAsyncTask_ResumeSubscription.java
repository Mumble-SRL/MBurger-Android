 ...
 */
public class MBPayAsyncTask_ResumeSubscription extends AsyncTask<Void, Void, Void> {
     ...
     */
    private String action = MBAPIConstants.ACTION_RESUME_SUBSCRIPTION;

    /**
     * If you wish to use a listener to retrieve the data instead of the ApiListener
     */
    private MBPayApiResumeSubscriptionListener listener;

    private int result = MBApiManagerConfig.COMMON_INTERNAL_ERROR;
    private String error;
    private Map<String, Object> map;

    public MBPayAsyncTask_ResumeSubscription(Context context, String subscription) {
        this.weakContext = new WeakReference<>(context);
        this.subscription = subscription;
    }

    public MBPayAsyncTask_ResumeSubscription(Context context, String custom_action, String subscription) {
        this.weakContext = new WeakReference<>(context);
        this.action = custom_action;
        this.subscription = subscription;
    }

    public MBPayAsyncTask_ResumeSubscription(Context context, MBPayApiResumeSubscriptionListener listener, String subscription) {
        this.weakContext = new WeakReference<>(context);
    ...
    public void putValuesAndCall() {
        ...
        map = MBAPIManager3.callApi(weakContext.get(), MBApiManagerConfig.API_SUBSCRIBE_RESUME, values,
