 ...
 */
public class MBPayAsyncTask_AddCard extends AsyncTask<Void, Void, Void> {
     ...
     */
    private String action = MBAPIConstants.ACTION_ADD_CARD;

    /**
     * If you wish to use a listener to retrieve the data instead of the ApiListener
     */
    private MBPayApiAddCardListener listener;

    private int result = MBApiManagerConfig.COMMON_INTERNAL_ERROR;
    private String error;
    private Map<String, Object> map;

    public MBPayAsyncTask_AddCard(Context context, String token) {
        this.weakContext = new WeakReference<>(context);
        this.token = token;
    }

    public MBPayAsyncTask_AddCard(Context context, String custom_action, String token) {
        this.weakContext = new WeakReference<>(context);
        this.action = custom_action;
        this.token = token;
    }

    public MBPayAsyncTask_AddCard(Context context, MBPayApiAddCardListener listener, String token) {
        this.weakContext = new WeakReference<>(context);
