...
public class MBMappingArgs {
    ...
    /**
     * Get first image or media from a Nooko {@link mumble.mburger.sdk.MBClient.MBData.MBElements.MBImages MBImages}
     */
    public static String mapping_first_image_media = "first";

    /**
     * Get only the address from a Nooko {@link mumble.mburger.sdk.MBClient.MBData.MBElements.MBAddressElement MBAddress}
     */
    public static String mapping_address = "first";

    /**
     * Get only the latitude from a Nooko {@link mumble.mburger.sdk.MBClient.MBData.MBElements.MBAddressElement MBAddress}
     */
    public static String mapping_latitude = "latitude";

    /**
     * Get only the longitude from a Nooko {@link mumble.mburger.sdk.MBClient.MBData.MBElements.MBAddressElement MBAddress}
     */
