 ...
 * {@link MBurgerMapper#mapToCustomObject(mumble.mburger.sdk.MBData.NKSections.MBSection, NKFieldsMapping, Object, boolean)}
 */
public class MBMappingArgs {

    /**
     * Get first image or media from a Nooko {@link mumble.mburger.sdk.MBData.NKElements.MBImages NImages}
     */
    public static String mapping_first_image_media = "first";

    /**
     * Get only the address from a Nooko {@link mumble.mburger.sdk.MBData.NKElements.MBAddressElement NAddress}
     */
    public static String mapping_address = "first";

    /**
     * Get only the latitude from a Nooko {@link mumble.mburger.sdk.MBData.NKElements.MBAddressElement NAddress}
     */
