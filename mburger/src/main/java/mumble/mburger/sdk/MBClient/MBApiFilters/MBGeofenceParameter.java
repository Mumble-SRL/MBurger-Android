 ...
 */
public class MBGeofenceParameter implements Serializable{
    ...
    public MBGeofenceParameter(double latitudeNE, double longitudeNE, double latitudeSW, double longitudeSW) {
